...
module.exports = async function (siteUrl) {
  ...
  const githubReleaseList = await (await fetch("https://gitee.com/hust-open-atom-club/mirrorrequest/raw/master/tunasync-scripts/github-release.json")).json();
  ...
  if (githubRelease) {
    githubReleaseList.forEach(item => {
      mirrors.push({
